export class GameView {
  ...
  createViewStartQuestion() {
    ...
    sectionStartQuestionDiv.append(
      sectionStartQuestionBtnNumber,
      sectionStartQuestionBtnPrize,
      sectionStartQuestionBtnPlay
    );
    sectionStartQuestion.append(
      sectionStartQuestionTitleH1,
      sectionStartQuestionDiv
    );
  ...
  createViewQuestion() {
    ...
    sectionQuestionBtnQuestionA.addEventListener("click", () => {
      this.gameState.setSelectedAnswer(0);
    });
    ...
    sectionQuestionBtnQuestionB.addEventListener("click", () => {
      this.gameState.setSelectedAnswer(1);
    });
    ...
    sectionQuestionBtnQuestionC.addEventListener("click", () => {
      this.gameState.setSelectedAnswer(2);
    });
    ...
    sectionQuestionBtnQuestionD.addEventListener("click", () => {
      this.gameState.setSelectedAnswer(3);
    });
    ...
    sectionQuestionDiv.append(
      sectionQuestionBtnQuestionA,
      sectionQuestionBtnQuestionB,
      sectionQuestionBtnQuestionC,
      sectionQuestionBtnQuestionD
    );
  ...
  createViewAnswer() {
    ...
    sectionAnswernBtnQuestionTitle.textContent =
      "¿Qué obra de Dante Alighieri cuenta con tres partes, 'Infierno', 'Purgatorio' y 'Paraíso'?";
    ...
    sectionAnswerDiv.append(
      sectionAnswerBtnQuestionA,
      sectionAnswerBtnQuestionB,
      sectionAnswerBtnQuestionC,
      sectionAnswerBtnQuestionD
    );
    sectionAnswer.append(
      sectionAnswerTitleH1,
      sectionAnswernBtnQuestionTitle,
      sectionAnswerDiv,
      sectionAnswerBtnPlay
    );
  ...
  updateQuestionContent() {
    ...
    const spanFirstAnswer = document.querySelector(
      "#question > div > button:nth-child(1) > span.spanOption"
    );
    spanFirstAnswer.textContent = question.answer[0].text;
    const spanSecondAnswer = document.querySelector(
      "#question > div > button:nth-child(2) > span.spanOption"
    );
    spanSecondAnswer.textContent = question.answer[1].text;
    const spanThirdAnswer = document.querySelector(
      "#question > div > button:nth-child(3) > span.spanOption"
    );
    spanThirdAnswer.textContent = question.answer[2].text;
    const spanFourthAnswer = document.querySelector(
      "#question > div > button:nth-child(4) > span.spanOption"
    );
  ...
  updateAnswerContent() {
    ...
    // Busca el boton de las respuestas
    const spanFirstAnswer = document.querySelector(
      "#answer > div > button:nth-child(1) > span.spanOption"
    );
    spanFirstAnswer.textContent = question.answer[0].text;
    const spanSecondAnswer = document.querySelector(
      "#answer > div > button:nth-child(2) > span.spanOption"
    );
    spanSecondAnswer.textContent = question.answer[1].text;
    const spanThirdAnswer = document.querySelector(
      "#answer > div > button:nth-child(3) > span.spanOption"
    );
    spanThirdAnswer.textContent = question.answer[2].text;
    const spanFourthAnswer = document.querySelector(
      "#answer > div > button:nth-child(4) > span.spanOption"
    );
    spanFourthAnswer.textContent = question.answer[3].text;
    ...
    const btnAnswer = document.querySelector(
      `#answer > div > button:nth-child(${
        this.gameState.getSelectedAnswer() + 1
      })`
    );
    btnAnswer.classList.add(
      this.gameState.getIsCorrectAnswer()
        ? "btnQuestionAnswerOk"
        : "btnQuestionAnswerWrong"
    );
    if (!this.gameState.getIsCorrectAnswer()) {
      const correctAnswer = this.gameState
        .getQuestion()
        .answer.findIndex((answer) => answer.correct);
      const btnCorrectAnswer = document.querySelector(
        `#answer > div > button:nth-child(${correctAnswer + 1})`
      );
  ...
  updateStartQuestionContent() {
    ...
    const btnQuestionPrize = document.querySelector(
      "#start-question > div > button.btnGame.btnQuestionPrize"
    );
    btnQuestionPrize.textContent = `$ ${
      this.gameState.prizes[this.gameState.getQuestionLevel()]
    }`;
  }
  ...
  displayCurrentSection() {
    ...
    if (this.gameState.getCurrentSection() === "answer") {
      this.updateAnswerContent();
    }
    if (this.gameState.getCurrentSection() === "start-question") {
    ...
    const section = document.getElementById(this.gameState.getCurrentSection());
